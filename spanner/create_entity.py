...
def main():
    ...
    crate_entiy_for_compare("Drippers", entity)

# todo レコードの返却方法について再度要検討
def crate_entiy_for_compare(table_name, entity):
    """
    Description:
    ...
    Args:
        ...
        entity (str): Spannerから取得したレコードのリスト
    Returns:
        dict: {"TBL_NAME": [{"column1": "values"}, {{"column２": "values"}}], "confidential": ["confidentialA"]}
